...
type RegisterCollateralProposal struct {
	...
	MintingRatio     uint64                                  `protobuf:"varint,6,opt,name=minting_ratio,json=mintingRatio,proto3" json:"minting_ratio,omitempty"`
...
var fileDescriptor_179ea2155667c8d4 = []byte{
	...
	0xf5, 0x99, 0x37, 0xfd, 0x80, 0x6c, 0x97, 0x5c, 0x20, 0x17, 0x79, 0xdd, 0x1a, 0x97, 0x66, 0x89,
	0xed, 0x78, 0xcb, 0x82, 0x71, 0x8d, 0xd1, 0x47, 0x64, 0xa7, 0xe0, 0x1f, 0x27, 0x3c, 0xab, 0x27,
	0x61, 0x85, 0x76, 0x1b, 0x2b, 0x84, 0x11, 0x2f, 0xfb, 0x3d, 0x7a, 0xf6, 0x75, 0xea, 0xbb, 0x97,
	0x53, 0xdf, 0xbd, 0x9a, 0xfa, 0xee, 0xaf, 0xa9, 0xef, 0x7e, 0x99, 0xf9, 0xce, 0xd5, 0xcc, 0x77,
	0xbe, 0xcf, 0x7c, 0xe7, 0xfd, 0xbd, 0xf9, 0x4d, 0x9e, 0x47, 0xf3, 0x97, 0xc9, 0x99, 0x74, 0xcd,
	0x71, 0x3d, 0xfd, 0x13, 0x00, 0x00, 0xff, 0xff, 0x13, 0x5a, 0xef, 0x87, 0xb5, 0x03, 0x00, 0x00,
}
...
func (m *RegisterCollateralProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MintingRatio != 0 {
		i = encodeVarintProposal(dAtA, i, uint64(m.MintingRatio))
		i--
		dAtA[i] = 0x30
	}
	{
...
func (m *RegisterCollateralProposal) Size() (n int) {
	...
	n += 1 + l + sovProposal(uint64(l))
	if m.MintingRatio != 0 {
		n += 1 + sovProposal(uint64(m.MintingRatio))
	}
	if m.LiquidationRatio != 0 {
